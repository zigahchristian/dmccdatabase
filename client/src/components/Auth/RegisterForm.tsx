...
const RegisterForm = () => {
  ...
  async function onSubmit(values: RegisterValues){
      ...
      if (res === 'OK'){
        showNotification({message:"Registration was successful - Login Now", type:"success"})
        return navigate('/login', { replace: true });
      }
      return showNotification({message:res.split(",")[1], type:"error"})
  }

  return (
    <div className="w-full h-full bg-cover bg-no-repeat bg-center dark:bg-gray-800  shadow-md px-8 py-10 flex flex-col items-center" style={{
      backgroundImage:
        `url('${authbg}')`,
    }}>
