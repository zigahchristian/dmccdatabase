...
const AddMember = () => {
  ...
  const { newMember, dispatch } = useContext(RegisterContext);
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      baptised_datebaptism: newMember?.baptised_datebaptism || undefined,
      ...
      firstcommunion_datefirstcommunion:
        newMember?.firstcommunion_datefirstcommunion || undefined,
      ...
      confirmed_datefconfirmation:
        newMember?.confirmed_datefconfirmation || undefined,
      ...
      married_dateofholymatrimony:
        newMember?.married_dateofholymatrimony || undefined,
